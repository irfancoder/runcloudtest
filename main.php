...
/*
* Setting Up required details --- Slight modification made. Initialized through constructor
...
// Modified
print "Setting up required details !\n\n";
$user = new User("Ashraf Kamarudin");
$server_1 = new Server("Server 1", "192.168.0.1");
$server_2 = new Server("Server 2", "192.168.0.2");
